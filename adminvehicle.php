...
.hai{
    width: 100%;
    background: linear-gradient(to top, rgba(0,0,0,0)50%, rgba(0,0,0,0)50%),url("../images/carbg3.jpg");
        ...
        <div>
            ...
            <div>
                ...
                <tr  class="active-row">
                    ...
                    <td><button type="submit" class="but" name="approve"><a href="updatecar.php?id=<?php echo $res['CAR_ID']?>">UPDATE CAR</a></button></td>
                </tr>
               <?php } ?>
                </tbody>
                </table>
