...
.invalid:before {
 ...
 <div class="main">
        ...
        <form id="register" action="register.php" method="POST">    
            ...
            id="name" placeholder="Enter Your License number(8 digits)" maxlength="8" minlength="8" onkeypress="return onlyNumberKey(event)" required>
            <br><br>

            <label>Phone Number : </label>
            <br>
            <input type="tel" name="ph" maxlength="10" minlength="10" onkeypress="return onlyNumberKey(event)"
