...
<?php 
    ...
    if(isset($_POST['book'])){
        ...
        $end_date = strtotime($_POST['rdate']);
       
       $dur=((($end_date - $start_date)/60/60/24)+1);
    ...
    ?>
       ...
       <div class="hai">
        ...
        <form id="register" method="POST"  >
            ...
            id="name" placeholder="Enter Your Destination" required>
            <br><br>

            <label>BOOKING DATE : </label>
            <br>
            <input type ="date" name="date"
            id="datefield" min='1899-01-01'  placeholder="ENTER THE DATE FOR BOOKING" required>
            <br><br>
            ...
            id="name" placeholder="Enter Your Phone Number" maxlength="10" minlength="10" onkeypress="return onlyNumberKey(event)" required>
            ...
            id="dfield"  min='1899-01-01' placeholder="Enter The Return Date" required>
            <br><br>
